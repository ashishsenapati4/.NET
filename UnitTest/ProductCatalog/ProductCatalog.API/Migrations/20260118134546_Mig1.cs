    ...
    public partial class Mig1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "ashish@example.com", "Ashish Senapati" },
                    { 2, "miss@example.com", "Miss Das" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "High performance laptop", "Laptop", 60000m, 20 },
                    { 2, "Latest smartphone", "Smartphone", 25000m, 50 },
                    { 3, "Ergonomic wireless mouse", "Wireless Mouse", 1500m, 100 }
                });
